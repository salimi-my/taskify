  ...
  (
    ...
    const CreatableItem = () => {
      ...
      if (
        isOptionsExist(options, [
          { id: inputValue, value: inputValue, label: inputValue }
        ]) ||
    ...
    return (
      ...
      >
        <div
          className={cn(
            'min-h-9 rounded-md border border-input text-sm focus-within:outline-none ring-inset focus-within:ring-1 focus-within:ring-ring',
            {
            ...
            {selected.map((option) => {
              return (
                ...
                >
                  ...
                  >
                    <X className='h-3 w-3 text-muted hover:opacity-70' />
                  </button>
                </Badge>
              );
            })}
